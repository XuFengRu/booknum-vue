...
<template>
  <div class="w-100 fade-in-up">
    <template v-if="selectedUser === null">
      <div class="position-relative mb-4 text-center fade-in-up">
        ...
        <div class="position-absolute top-0 end-0" style="z-index: 10">
          ...
          >
            <label
              class="form-check-label small fw-bold text-muted mb-0 d-none d-md-flex align-items-center"
              for="premiumToggle"
          ...
          >
            ...
            >
              <div class="gem-icon-wrapper mb-3">
                <i
                  class="bi bi-gem display-4 text-warning"
    ...
    <template v-else>
      <div
        class="d-flex justify-content-center align-items-center w-100 fade-in-up"
        style="min-height: 70vh"
      >
        <div
          class="position-relative d-flex justify-content-center w-100"
