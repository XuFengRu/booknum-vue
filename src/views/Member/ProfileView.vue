      ...
      <div class="row g-0 h-100">
        ...
        <div class="col-lg-6 h-100 p-4 p-xl-5 bg-white d-flex flex-column border-end border-light-subtle">
          ...
          <div class="mb-4 pb-3 border-bottom border-light-subtle">
            <h3 class="fw-bolder mb-0 text-gradient"><i class="bi bi-person-vcard me-2"></i>個人資料</h3>
          </div>
        ...
        <div class="col-lg-6 h-100 p-4 p-xl-5 bg-light d-flex flex-column">
          ...
          <h5 class="fw-bold text-dark mb-3"><i class="bi bi-gem text-warning me-2"></i>訂閱管理</h5>
          <div class="bg-white rounded-4 p-4 border border-light-subtle shadow-sm mb-4 position-relative overflow-hidden">
            ...
            <div class="position-relative z-1">
              <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <span v-if="isPremium" class="badge bg-warning text-dark fw-bold px-3 py-1 rounded-pill shadow-sm"><i class="bi bi-check-circle-fill me-1"></i>啟用中</span>
                <span v-else class="badge bg-secondary text-white fw-bold px-3 py-1 rounded-pill shadow-sm">尚未訂閱</span>
              </div>
              <div class="mb-2">
                <span class="text-muted small fw-bold me-2">到期日：</span>
                <span class="text-dark fw-bold fs-6">{{ isPremium ? premiumExpiryDate : '無' }}</span>
              </div>
          ...
          <h5 class="fw-bold text-dark mb-3"><i class="bi bi-envelope-paper text-primary me-2 opacity-75"></i>帳號資訊</h5>
          <div class="bg-white rounded-4 p-4 border border-light-subtle shadow-sm mb-4">
              ...
              <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span class="badge bg-success bg-opacity-10 text-success border border-success rounded-pill px-3 py-1 shadow-sm">
                      <i class="bi bi-check-circle-fill me-1"></i> 已驗證
                  </span>
              </div>
          </div>

          <h5 class="fw-bold text-dark mb-3 mt-auto"><i class="bi bi-cpu text-primary me-2 opacity-75"></i>系統紀錄</h5>
