...
const handleLogin = async () => {
    ...
    try {
        ...
        router.push('/member/dating/info')
    } catch (error) {
...
<template>
    <OAuthCard>
        ...
        <template #left-side>
            ...
            <i class="bi bi-chat-heart-fill floating-obj fs-1"
        ...
        <form @submit.prevent="handleLogin">
            ...
            <div class="text-center mb-4 position-relative">
                ...
                <span
                    class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted small">或使用以下方式</span>
            </div>
