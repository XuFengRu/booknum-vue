    ...
    <div class="card overflow-hidden border-0 rounded-5 flex-fill" style="max-width: 1050px">
      <div class="row g-0 h-100">
        <div class="col-md-5 position-relative image-container">
          ...
          />
          <div
            class="d-md-none position-absolute bottom-0 start-0 w-100 h-25"
        ...
        <div class="col-md-7 bg-white">
          <div
            class="card-body p-4 p-lg-5 d-flex flex-column justify-content-center h-100 text-start"
          >
            ...
            <div
              class="mb-5 text-secondary d-flex flex-wrap gap-4 fs-5 text-uppercase fw-bold"
