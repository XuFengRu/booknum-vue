            ...
            <div id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush mt-3 px-3 gap-2">
                    ...
                    >
                        ...
                        <span v-if="item.badge" class="badge bg-gradient ms-auto rounded-pill" style="font-size: 0.7rem;">
                            {{ item.badge }}
                        </span>
                    </RouterLink>
                ...
                <div class="sidebar-footer p-3 mt-auto">
                    <div class="card border-0 bg-pink-light rounded-4">
                        <div class="card-body p-3 sidebar-text">
                            ...
                            <button class="btn btn-warning text-white w-100 rounded-pill btn-sm shadow-sm fw-bold mt-2" style="background: #ffc107; border:none;">立即升級</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <button class="btn btn-link text-dark p-0 border-0" id="sidebarToggle" @click="toggleSidebar">
                            <i class="bi bi-list fs-4"></i>
                        </button>

                        <div class="d-none d-md-flex align-items-center gap-4 position-absolute start-50 translate-middle-x">
                            <RouterLink to="/member/dating" class="nav-link fw-bold text-gradient-hover" active-class="active">交友配對</RouterLink>
                            <RouterLink to="/member/rent" class="nav-link fw-bold text-muted text-gradient-hover" active-class="active">出租男女友</RouterLink>
                            <RouterLink to="/member/group" class="nav-link fw-bold text-muted text-gradient-hover" active-class="active">揪團</RouterLink>
                        </div>

                        <div class="d-flex align-items-center gap-3 ms-auto">
                            <div class="dropdown">
                                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-body" data-bs-toggle="dropdown">
                                    <img src="/images/Girlfriend1.jpg" class="rounded-circle object-fit-cover border border-2 border-white shadow-sm me-2" style="width: 38px; height: 38px;" alt="User">
                                    <span class="d-none d-sm-inline fw-bold small">UserName</span>
                                </a>
<ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-4 mt-2">
    <li><RouterLink class="dropdown-item" to="/member/profile">個人資料</RouterLink></li>
    <li><RouterLink class="dropdown-item" to="/member/security">帳號設定</RouterLink></li>
    <li><hr class="dropdown-divider"></li>
    <li><RouterLink class="dropdown-item text-danger" to="/login">登出</RouterLink></li>
</ul>
                            </div>
                        </div>
                    </div>
